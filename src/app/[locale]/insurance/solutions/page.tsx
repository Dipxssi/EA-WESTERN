  ...
  return (
    <div className="theme-insurance bg-[#f7f5f0] text-[#4a5568] min-h-screen font-sans w-full overflow-x-hidden selection:bg-[#c9a96e] selection:text-[#1a2e45]">
      ...
      <main className="w-full pt-20">
        {/* PREMIUM SPLIT HERO */}
        <section className="relative w-full min-h-[80vh] flex items-center bg-[#f7f5f0] overflow-hidden">
          <div className="absolute inset-0 w-full h-full">
             <div className="absolute inset-0 bg-gradient-to-r from-[#f7f5f0] via-[#f7f5f0]/90 to-transparent z-10 lg:w-2/3"></div>
          ...
          <div className="relative z-20 max-w-[1300px] w-full mx-auto px-6 md:px-10 py-20 flex flex-col justify-center h-full">
            <motion.div initial="hidden" animate="visible" variants={fadeInUp} custom={0} className="max-w-2xl">
               <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-2 mb-8">
                 ...
                 <span className="text-[#1a2e45] text-xs font-bold uppercase tracking-widest">Comprehensive Coverage</span>
               </div>
               
               <h1 className="text-[56px] lg:text-[80px] text-[#1a2e45] font-bold mb-6 leading-[1.05] font-playfair tracking-tight">
                 Protection that <br /> <span className="italic text-[#c9a96e] font-normal">empowers you.</span>
               </h1>
               
               <p className="text-[#4a5568] text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
               ...
               <div className="flex flex-col sm:flex-row gap-4">
                 <a href="#personal" className="bg-[#c9a96e] hover:bg-[#a8823d] text-[#1e3a5f] px-8 py-4 rounded-[12px] text-sm font-bold transition-all inline-flex justify-center items-center gap-2 shadow-xl shadow-[#c9a96e]/30 group">
                    Explore Personal <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                 </a>
                 <a href="#business" className="bg-white hover:bg-[#ede9e1] text-[#1e3a5f] border border-[#dcd8cf] px-8 py-4 rounded-[12px] text-sm font-bold transition-all backdrop-blur-sm inline-flex justify-center items-center gap-2">
        ...
        <section className="py-32 bg-white">
           <div className="max-w-[1300px] mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <div>
                 <div className="text-[#4a7fa5] font-bold text-xs uppercase tracking-[0.2em] mb-4">Our Methodology</div>
                 ...
                 <div className="space-y-10">
                    {[
                      ...
                      { step: '03', title: 'Selection & Support', desc: 'We help you choose the best plan and provide continuous support, especially during the claims process.' }
                       ...
                       >
                          <div className="text-[40px] font-bold text-transparent bg-clip-text bg-gradient-to-b from-slate-200 to-slate-100 font-playfair group-hover:from-[#4a7fa5] group-hover:to-[#1e3a5f] transition-colors duration-500">{s.step}</div>
                          <div>
              ...
              <div className="relative">
                 <div className="absolute inset-0 bg-gradient-to-tr from-[#c9a96e] to-[#4a7fa5] rounded-[48px] blur-2xl opacity-20 transform rotate-3"></div>
                 <div className="aspect-[4/5] rounded-[48px] bg-[#f7f5f0] border border-[#ede9e1] p-12 flex flex-col items-center justify-center text-center overflow-hidden relative shadow-2xl">
                    <div className="absolute inset-0 bg-[url('/images/noise.png')] opacity-20 mix-blend-overlay"></div>
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#ede9e1]/90 z-0"></div>
                    
                    <div className="relative z-10 w-full">
                       <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#c9a96e] to-[#a8823d] flex items-center justify-center mx-auto mb-10 shadow-[0_0_40px_rgba(201,169,110,0.5)]">
                          <Check size={40} className="text-white" strokeWidth={3} />
                       </div>
                       <h3 className="text-[32px] md:text-[40px] text-[#1a2e45] font-bold mb-4 font-playfair">Ready to Begin?</h3>
                       <p className="text-[#4a5568] mb-12 text-lg">Experience the eawestern difference and secure your peace of mind today.</p>
                       <Link 
                         href={`/${locale}/insurance/contact`}
                         className="bg-[#c9a96e] text-[#1e3a5f] px-10 py-5 rounded-full font-bold text-sm uppercase tracking-widest hover:bg-[#a8823d] hover:text-[#1a2e45] transition-all shadow-xl inline-flex items-center gap-3"
                       >
        ...
        <section className="py-32 bg-[#f7f5f0] relative overflow-hidden">
           <div className="absolute inset-0 opacity-40 bg-[radial-gradient(circle_at_center,_#c9a96e_0%,_transparent_25%)] mix-blend-multiply pointer-events-none"></div>
           <div className="max-w-[800px] mx-auto px-6 text-center relative z-10">
              <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-8 shadow-md">
                 <ShieldCheck size={32} className="text-[#4a7fa5]" />
              </div>
              ...
              <div className="flex justify-center">
                 <Link 
                   href={`/${locale}/insurance/contact`}
                   className="bg-[#c9a96e] text-[#1e3a5f] px-10 py-5 rounded-[16px] font-bold hover:bg-[#a8823d] hover:text-[#1a2e45] transition-all flex items-center gap-3 shadow-xl hover:-translate-y-1"
                 >
