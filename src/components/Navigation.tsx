  ...
  return (
    <nav className="bg-white/95 backdrop-blur-xl border-b border-gray-200 sticky top-0 z-50">
      ...
      <select className="hidden sm:block bg-transparent border border-gray-300 rounded-none px-3 py-2 text-sm text-gray-800 focus:outline-none focus:border-black">
            ...
            <button className="hidden md:block bg-blue-900 hover:bg-red-900 text-white px-6 lg:px-8 py-3 font-light tracking-widest text-sm transition-all duration-300 uppercase rounded-full border-2 border-white hover:border-white shadow-lg flex items-center justify-center min-h-[48px]">
              TALK WITH US
            </button>
