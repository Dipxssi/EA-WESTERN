        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${isMenuOpen
          ...
          <div className="py-4 space-y-4 border-t border-gray-200">
            ...
            <Link
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-info"><circle cx="12" cy="12" r="10" /><line x1="12" x2="12" y1="16" y2="12" /><line x1="12" x2="12.01" y1="8" y2="8" /></svg> ABOUT
            </Link>
            <Link
              href={`/${locale}/safaris`}
              className="block py-3 text-gray-800 hover:text-black font-light tracking-wide transition-colors duration-300 text-base uppercase"
