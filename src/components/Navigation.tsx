      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${isMenuOpen
          ...
          <div className="py-4 space-y-4 border-t border-gray-200">
            ...
            <Link
              href={`/${locale}`}
              className={`block py-3 font-light tracking-wide transition-colors duration-300 text-base uppercase ${
                isActive(`/${locale}`)
            ...
            <Link
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-info"><circle cx="12" cy="12" r="10" /><line x1="12" x2="12" y1="16" y2="12" /><line x1="12" x2="12.01" y1="8" y2="8" /></svg> ABOUT US
            </Link>
            <Link
              href={`/${locale}/safaris`}
              className={`block py-3 font-light tracking-wide transition-colors duration-300 text-base uppercase ${
            ...
            <Link
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-shield-icon lucide-shield"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" /></svg> INSURANCE SOLUTIONS
            </Link>
            <Link
              href={`/${locale}/vehicles`}
              className={`block py-3 font-light tracking-wide transition-colors duration-300 text-base uppercase ${
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-car-icon lucide-car"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2" /><circle cx="7" cy="17" r="2" /><path d="M9 17h6" /><circle cx="17" cy="17" r="2" /></svg> CAR HIRE
            </Link>
            ...
            <div className="pt-4">
              <Link
                href={`/${locale}/contact`}
                className="w-full bg-blue-900 hover:bg-red-900 text-white py-4 px-6 font-light tracking-widest text-sm transition-all duration-300 uppercase rounded-full border-2 border-white hover:border-white shadow-lg flex items-center justify-center min-h-[56px]"
                onClick={() => setIsMenuOpen(false)}
              >
                TALK WITH US
              </Link>
