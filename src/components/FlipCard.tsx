...
export function FlipCard({ destination, locale }: FlipCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="p-8 space-y-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 text-blue-900 font-semibold py-3 border border-blue-200 rounded-xl hover:bg-blue-50 transition-colors"
            >
        ...
        {/* Back Side */}
        <div
          className="absolute inset-0 p-8 space-y-6 bg-gradient-to-br from-white via-slate-50 to-blue-50"
          style={{
            backfaceVisibility: 'hidden',
            WebkitBackfaceVisibility: 'hidden',
