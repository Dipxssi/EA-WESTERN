      ...
      <div className="max-w-6xl mx-auto px-6" style={{ pointerEvents: 'auto' }}>
        ...
        <div className="grid md:grid-cols-3 gap-6" style={{ pointerEvents: 'auto' }}>
          ...
          >
            ...
            <h3 className="text-base font-semibold text-center mb-4 text-black group-hover:text-blue-600 transition-colors duration-300" style={{ pointerEvents: 'none' }}>Plan My Safari</h3>
